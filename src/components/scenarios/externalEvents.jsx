...
export const EXTERNAL_EVENTS = {
  "気候・環境": {
    ...
    long: [
      "2100年時点で世界平均気温が産業革命前比3℃前後（高排出シナリオ）か1.5〜2℃程度（強力対策シナリオ）かで2本立てのイベント",
      "2100年までに一部の低地島嶼国で居住継続が困難になり、計画的移住が現実の政策テーマになるシナリオ"
    ]
  },
  "エネルギー・資源": {
    short: [
    ...
    medium: [
      "先進国では2045年前後にネットゼロ達成を目指し、化石燃料関連の新規雇用がほぼゼロになるシナリオ",
    ...
    long: [
      ...
      "2100年までに主要都市が「エネルギー自給都市」（建物・太陽光・蓄電が標準）へ移行するシナリオ"
    ]
  },
  "人口・都市・移動": {
    short: [
    ...
    medium: [
      "2050年 世界人口約9.7十億人、そのうちアフリカが強いシェア拡大を見せるシナリオ",
      "2050年までに都市人口がさらに25億人増え、その90%近くがアジアとアフリカに集中するシナリオ",
      "気候変動や紛争を背景とした「国内外の環境移民」が累積で数億人規模になるシナリオ"
    ],
    long: [
      "アフリカが世界人口の40%近くを占めるようになるシナリオ",
      "一部のメガシティが人口減少と老朽インフラ問題で「縮小都市」として再編されるシナリオ"
    ]
  },
  "経済・金融": {
    short: [
      "2030年に日本の潜在成長率が0.5%まで低下し、大企業の定期昇給制度が事実上崩壊。年功序列から成果主義への完全移行が進み、30代で年収1000万と400万の2極化が鮮明に",
    ...
    medium: [
      "2050年ごろ インドがGDP規模で世界2位、中国の成長鈍化が続き多極化が進むシナリオ",
      "技術進歩は続くが格差拡大により「平均は豊かだが分布は2極化」という経済構造になるシナリオ",
      "AIと自動化によりホワイトカラーの一部職種が大きく縮小し、サービス・ケア・創造的職種が相対的に拡大するシナリオ"
    ],
    long: [
      "労働人口減少と生産性停滞で、OECDとG20全体の成長率が1%台前半に張り付くシナリオ",
  ...
  "健康・医療・食": {
    ...
    medium: [
      "2050年までに世界平均寿命がさらに4〜5年延びるという予測を前提に、100年人生が標準になるシナリオ",
  ...
  "社会構造・働き方": {
    ...
    medium: [
      "高齢社会で70歳前後まで働くことが一般的になり、教育と仕事を繰り返すマルチステージ型人生になるシナリオ",
